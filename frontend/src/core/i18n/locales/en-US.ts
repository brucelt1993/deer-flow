...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 Aether, an open source super agent. With built-in and custom skills, Aether helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Aether. With customized skills,\nAether can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Aether is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Aether could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Aether",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Aether faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Aether looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Aether automatically learns from your conversations in the background. These memories help Aether understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Aether.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Aether only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
