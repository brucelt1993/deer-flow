...
description: This tutorial shows you how to use the Aether Harness programmatically — importing and using Aether directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the Aether Harness programmatically — importing and using Aether directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- Aether repository cloned
