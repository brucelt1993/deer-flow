...
description: This tutorial shows you how to configure and use tools and skills in Aether to give the agent access to web search, file operations, and domain-specific capabilities.
---
...
This tutorial shows you how to configure and use tools and skills in Aether to give the agent access to web search, file operations, and domain-specific capabilities.
...
Enable skills through the Aether app's extensions panel, or edit `extensions_config.json` directly.

**Via the app UI:**

1. Open the Aether app
