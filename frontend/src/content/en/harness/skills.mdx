...
Aether ships with the following public skills:
...
- **Through the Aether App UI**: the skills panel lets you toggle skills on and off.
...
Aether includes an optional **skill evolution** feature that allows the agent to autonomously create and improve skills in the `skills/custom/` directory:
