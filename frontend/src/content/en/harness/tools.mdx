...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. Aether provides built-in
...
Aether organizes tools into four categories:
...
Install: `cd backend && uv add 'Aether-harness[tavily]'`
...
Install: `cd backend && uv add 'Aether-harness[exa]'`
...
Install: `cd backend && uv add 'Aether-harness[firecrawl]'`
