...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes Aether capable of real action, not just
  conversation.
</Callout>
...
Aether supports three sandbox modes. Choose the one that fits your deployment:
