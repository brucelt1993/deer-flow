...
description: This page covers day-to-day operational tasks and solutions to common problems when running Aether App.
---
...
This page covers day-to-day operational tasks and solutions to common problems when running Aether App.
...
| File                 | Service                              |
| -------------------- | ------------------------------------ |
| `logs/langgraph.log` | LangGraph / Aether Harness runtime |
...
When you pull a new version of Aether, the `config_version` in `config.example.yaml` may be higher than your `config.yaml`. To merge new fields without losing your customizations:
