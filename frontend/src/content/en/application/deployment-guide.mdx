...
description: "This guide covers all supported deployment methods for Aether App: local development, Docker Compose, and production with Kubernetes-managed sandboxes."
---
...
This guide covers all supported deployment methods for Aether App: local development, Docker Compose, and production with Kubernetes-managed sandboxes.
...
| ----------- | ---- | ------------------------ |
| LangGraph   | 2024 | Aether Harness runtime |
...
Aether App uses [Better Auth](https://www.better-auth.com/) for session management. In production:
