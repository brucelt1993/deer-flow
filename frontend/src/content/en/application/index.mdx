---
title: Aether App
description: Aether App is the reference implementation of what a production Aether experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  Aether App is a complete Super Agent application built on top of Aether
...
Aether App is the reference implementation of what a production Aether experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The Aether App runs as four services behind a single nginx reverse proxy:
...
- **LangGraph**: the Aether Harness runtime. Manages thread state, agent execution, and streaming.
...
| Agent runtime     | LangGraph, LangChain, Aether Harness                               |
| Reverse proxy     | nginx                                                                |
