...
description: Aether App supports multiple named agents and maintains conversation state across sessions through threads and checkpointing.
---
...
Aether App supports multiple named agents and maintains conversation state across sessions through threads and checkpointing.
...
<Callout type="info">
  ...
  embedded <code>AetherClient</code> (used in direct Python integrations), not
  to the LangGraph Server deployment used by Aether App.
</Callout>
