---
title: 运维与排障
description: 本页面涵盖运行 Aether 靈境 应用的操作信息：日志记录、常见问题和维护任务。
---
...
本页面涵盖运行 Aether 靈境 应用的操作信息：日志记录、常见问题和维护任务。

## 日志

Aether 靈境 应用在 `logs/` 目录中写入每个服务的日志：
...
1. 确保 `backend/.deer-flow/` 对运行 Aether 靈境 的进程可写。
